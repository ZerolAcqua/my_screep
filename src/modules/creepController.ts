 ...
 * 更多细节 @link https://github.com/HoPGoldy/my-screeps-ai/blob/master/doc/creep%20%E6%8E%A7%E5%88%B6%E5%99%A8%E8%AE%BE%E8%AE%A1%E6%A1%88.md
 * @todo
 */
...
import { colorful, log } from '@/utils'
  ...
  * @param interval 搜索间隔
  */
export default function creepNumberListener(interval: number = 5): void {
    if (Game.time % interval) return
